...
export default {
    setup() {
        ...
        // 패턴 A
        const patternA = [
            [0,0,'S',3], [0,1,'L',3], [1,1,'I',0], [2,1,'L',1], [2,2,'I',1], [2,3,'L',0], [2,4,'P',3,0], // 구간1: P1(0)입
            [6,4,'P',1,0], [6,5,'I',1], [6,6,'I',1], [6,7,'I',1], [6,8,'L',0], [5,8,'I',0], [4,8,'L',0], [4,7,'I',1], [4,6,'L',2], [5,6,'L',0], [5,5,'L',2], [5,4,'L',1], [4,3,'L',3], [3,3,'I',0], [2,3,'I',0], [1,3,'I',0], [0,3,'L',2], [0,4,'L',3], [0,5,'P',3,1], // 구간2: P2(1)입
            [5,8,'P',0,1], [6,8,'I',0], [7,8,'L',0], [7,7,'I',1], [7,6,'I',1], [7,5,'I',1], [7,4,'L',1], [6,4,'I',0], [5,4,'I',0], [4,4,'I',0], [3,4,'I',0], [3,5,'I',1], [3,6,'L',1], [3,7,'P',1,2], // 구간3: P3(2)입
            [4,2,'P',3,2], [4,3,'L',3], [5,3,'L',1], [5,4,'I',1], [5,5,'L',0], [4,5,'L',2], [4,6,'I',1], [4,7,'I',1], [4,8,'L',0], [3,8,'L',2], [3,9,'L',3], [3,10,'L',2], [3,11,'E',1] // 구간4: 종료
        ];

        // 패턴 B
        const patternB = [
            [0,0,'S',3], [0,1,'L',3], [1,1,'I',0], [1,2,'L',2], [1,3,'I',1], [1,4,'I',1], [1,5,'I',1], [1,6,'L',0], [0,6,'L',3], [0,5,'P',1,0], // 구간1: P1(0)입
            [7,0,'P',3,0], [7,1,'I',1], [7,2,'I',1], [7,3,'I',1], [7,4,'I',1], [7,5,'I',1], [7,6,'I',1], [7,7,'L',0], [6,7,'P',2,2], [4,9,'P',1,1], // 구간2: P2(1)입
            [2,3,'P',0,1], [3,3,'I',0], [4,3,'L',1], [4,4,'I',1], [6,7,'P',2,2], // 구간3: P3(2)입
            [4,5,'P',0,2], [5,5,'I',0], [6,5,'L',1], [6,6,'I',1], [6,8,'L',1], [6,9,'L',0], [5,9,'I',0], [7,11,'L',0], [6,11,'I',0], [5,11,'E',2] // 구간4: 종료
        ];
