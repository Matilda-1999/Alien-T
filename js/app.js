...
export default {
    setup() {
        ...
        const getOpenings = (tile, r, c) => {
            // topsecret 모드에서 정답 경로면 무조건 ansRot(tile[5]) 사용
        ...
        for (let i = 0; i < gridheight; i++) {
            ...
            for (let j = 0; j < gridwidth; j++) {
                ...
                if (p) {
                    ...
                    // [핵심 수정] 포털/시작/끝점은 정답 각도(ansRot) 그대로 고정, 회전 타일만 섞음
        ...
        return {
            ...
            getColour: (r, c) => (showAnswer && checkIsCorrect(r, c)) || poweredTiles.value.has(`${r},${c}`) ? themeColor : '',
